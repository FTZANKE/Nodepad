...
| ------------------------------------------------------------ | ------------------------------------------ | ------------------ | ------------------------------------------------------------ |
| **[`url`](https://www.npmjs.com/package/css-loader#url)**    | `{Boolean|Object}`                         | `true`             | Allows to enables/disables `url()`/`image-set()` functions handling |
| **[`import`](https://www.npmjs.com/package/css-loader#import)** | `{Boolean|Object}`                         | `true`             | Allows to enables/disables `@import` at-rules handling       |
| **[`modules`](https://www.npmjs.com/package/css-loader#modules)** | `{Boolean|String|Object}`                  | `{auto: true}`     | Allows to enables/disables or setup CSS Modules options      |
| **[`sourceMap`](https://www.npmjs.com/package/css-loader#sourcemap)** | `{Boolean}`                                | `compiler.devtool` | Enables/Disables generation of source maps                   |
| **[`importLoaders`](https://www.npmjs.com/package/css-loader#importloaders)** | `{Number}`                                 | `0`                | Allows enables/disables or setups number of loaders applied before CSS loader for `@import`/CSS Modules and ICSS imports |
| **[`esModule`](https://www.npmjs.com/package/css-loader#esmodule)** | `{Boolean}`                                | `true`             | Use ES modules syntax                                        |
| **[`exportType`](https://www.npmjs.com/package/css-loader#exporttype)** | `{'array' | 'string' | 'css-style-sheet'}` | `array`            | Allows exporting styles as array with modules, string or [constructable stylesheet](https://developers.google.com/web/updates/2019/02/constructable-stylesheets) (i.e. [`CSSStyleSheet`](https://developer.mozilla.org/en-US/docs/Web/API/CSSStyleSheet)) |
...
| Name                                                         | Type         | Default     | Description               |
| ------------------------------------------------------------ | ------------ | ----------- | ------------------------- |
| **[`filter`](https://www.npmjs.com/package/css-loader#filter)** | `{Function}` | `undefined` | Allow to filter `@import` |
...
Type: `Boolean|RegExp|Function` Default: `undefined`
...
- `true` - enables CSS modules or interoperable CSS format, sets the [`modules.mode`](https://www.npmjs.com/package/css-loader#mode) option to `local` value for all files which satisfy `/\.module(s)?\.\w+$/i.test(filename)` condition or sets the [`modules.mode`](https://www.npmjs.com/package/css-loader#mode) option to `icss` value for all files which satisfy `/\.icss\.\w+$/i.test(filename)` condition
...
Allows to add custom hash to generate more unique classes. For more information see [output.hashSalt](https://webpack.js.org/configuration/output/#outputhashsalt).
...
Allows to specify hash function to generate classes . For more information see [output.hashFunction](https://webpack.js.org/configuration/output/#outputhashfunction).
...
Allows to specify hash digest to generate classes. For more information see [output.hashDigest](https://webpack.js.org/configuration/output/#outputhashdigest).
...
Allows to specify hash digest length to generate classes. For more information see [output.hashDigestLength](https://webpack.js.org/configuration/output/#outputhashdigestlength).
...
To set a custom name for namedExport, can use [`exportLocalsConvention`](https://www.npmjs.com/package/css-loader#exportLocalsConvention) option as a function. Example below in the [`examples`](https://www.npmjs.com/package/css-loader#examples) section.
...
Type: `String|Function` Default: based on the `modules.namedExport` option value, if `true` - `camelCaseOnly`, otherwise `asIs`
...
Type: `'array' | 'string' | 'css-style-sheet'` Default: `'array'`

Allows exporting styles as array with modules, string or [constructable stylesheet](https://developers.google.com/web/updates/2019/02/constructable-stylesheets) (i.e. [`CSSStyleSheet`](https://developer.mozilla.org/en-US/docs/Web/API/CSSStyleSheet)). Default value is `'array'`, i.e. loader exports array of modules with specific API which is used in `style-loader` or other.
