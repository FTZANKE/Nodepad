...
如果你有多个“webpack”入口点，它们都将包含在生成的HTML中的“script”标签中。  [^译文]
...
如果你在webpack的输出中有任何CSS资源(例如，用[mini-css-extract-plugin](https://github.com/webpack-contrib/mini-css-extract-plugin)提取的CSS)  然后这些将包括 `<link>` 标签在HTML头。[^译文]

If you have plugins that make use of it, `html-webpack-plugin` should be ordered first before any of the integrated Plugins.

如果你有使用它的插件， `html-webpack-plugin` 应该在任何集成的插件之前先订购。[^译文]
