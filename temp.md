> `src\utils\get-page-title.js`  修改页面标题
>
> `src\views\login\index.vue` `getName()` 登录页面表单标题
...
<script>
    export default {
        data() {
            return {
                pickerOptions: {
                    disabledDate: (time) => {
                        let date = new Date(this.currData);
    ...
    currData: new Date(),//当天时间
</script>
<template>
<el-date-picker placeholder="请选择" v-model="ruleForm.billDate" value-format="yyyy-MM-dd" class="data" size="small"/>
</template>
```
...
![Merge Editor Conflict Resolution Demo](https://code.visualstudio.com/raw/images/1_69/merge-editor.gif)
...
![Editing the result directly updates the checkbox states](https://code.visualstudio.com/raw/images/1_69/merge-editor2.gif)
...
![Accepting both sides of a merge conflict](https://code.visualstudio.com/raw/images/1_69/merge-editor3.gif)
...
![The Command Center and its hover message atop the window](https://code.visualstudio.com/raw/images/1_69/cc-polish.png)
...
![Showing the new Modified elsewhere and default override indicators, along with the custom hover](https://code.visualstudio.com/raw/images/1_69/settings-editor-new-indicators.gif)

*Theme: [Light Pink](https://marketplace.visualstudio.com/items?itemName=mgwg.light-pink-theme)*
...
![Do Not Disturb mode shown in the Status bar and Notification center](https://code.visualstudio.com/raw/images/1_69/do-not-disturb.jpg)
...
![Minimap context menu](https://code.visualstudio.com/raw/images/1_69/minimap-context-menu.png)
...
![Share menu with Copy vscode.dev Link command](https://code.visualstudio.com/raw/images/1_69/share-vscode-dev-link.gif)
...
![Blue circles appear next to successful commands, red circles with crosses appear next to failed commands. The color of the circles appears in the scroll bar](https://code.visualstudio.com/raw/images/1_69/terminal-si-decorations.png)

The decorations can support contextual actions like rerunning the command:

![Clicking a successful command decoration shows a context menu containing items: Copy Output, Copy Output as HTML, Rerun Command and How does this work?](https://code.visualstudio.com/raw/images/1_69/terminal-si-decoration-menu.png)
...
![Ctrl+Up and Ctrl+Down will navigate up and down between commands, Ctrl+Shift+Up and Ctrl+Shift+Down will do the same but also select between the 2 locations. To use this feature in screen readers it currently requires custom keybindings](https://code.visualstudio.com/raw/images/1_69/terminal-si-command-nav.gif)
...
![The "run recent command" command shows a Quick Pick with commands ran previously that can be filtered similar to the Go to File command](https://code.visualstudio.com/raw/images/1_69/terminal-si-recent-command.png)
...
![The Go to Recent Directory command shows a Quick Pick with directories previously navigated to, selecting one will run "cd path"](https://code.visualstudio.com/raw/images/1_69/terminal-si-go-to-dir.gif)
...
![When the sequence is written to the terminal, a small grey circle will appear to the left of the command, with a matching annotation in the scroll bar](https://code.visualstudio.com/raw/images/1_69/terminal-setmark.png)
...
![Line height would not be respected, leading to a Powerline symbol with a different height to adjacent cells. Additionally, a blue outline could appear when sub-pixel anti-aliasing was used](https://code.visualstudio.com/raw/images/1_69/terminal-powerline-before.png)

After:

![Line height is now respected and greyscale anti-aliasing is used for improved rendering](https://code.visualstudio.com/raw/images/1_69/terminal-powerline-after.png)
...
![Loud formatting starts the line with an asterisk with the inverted style, followed by a message using a blue background](https://code.visualstudio.com/raw/images/1_69/terminal-message-loud.png)

![Subtle formatting starts the line with an asterisk with the inverted style, followed by a message using the default background](https://code.visualstudio.com/raw/images/1_69/terminal-message-subtle.png)
...
![A task fails and an error decoration is added. A task succeeds and a success decoration is added](https://code.visualstudio.com/raw/images/1_69/task-success-fail.png)

For watch tasks, a decoration appears by the first reported problem for each compilation.

![A watch task's first error is marked with a decoration](https://code.visualstudio.com/raw/images/1_69/task-error.png)
...
![The task custom icon appears in the terminal tabs list](https://code.visualstudio.com/raw/images/1_69/task-icon.png)
...
![Making commits using the new commit action button](https://code.visualstudio.com/raw/images/1_69/scm-commit-action-button.gif)
...
![Author commit message in a full text editor](https://code.visualstudio.com/raw/images/1_69/scm-git-editor.gif)
...
![The branch protection icon is shown in the Status bar](https://code.visualstudio.com/raw/images/1_69/scm-branch-protection-statusbar.png)

Branch picker:

![The branch protection icon is shown in the branch picker](https://code.visualstudio.com/raw/images/1_69/scm-branch-protection-picker.png)
...
![filtering and selecting a Debug Console from the Quick Access list](https://code.visualstudio.com/raw/images/1_69/debug-filter-and-select.gif)

*Theme: [GitHub Dark Dimmed](https://marketplace.visualstudio.com/items?itemName=GitHub.github-vscode-theme)*

There are three different ways to access this Quick Access menu:

- Typing `?` in the Quick Open menu (`Ctrl+P`), then selecting the option to view Debug Consoles.

  ![Go to Quick Access](https://code.visualstudio.com/raw/images/1_69/goto-debug-quickaccess.gif)
...
![Accessing the Debug Console via View menu](https://code.visualstudio.com/raw/images/1_69/debug-view-menu.gif)

#### Toggling between consoles

You can now use `Ctrl+PageUp` to navigate to the previous Debug Console and `Ctrl+PageDown` to go to the next console.
...
![Going to loaded script from Quick Open](https://code.visualstudio.com/raw/images/1_69/loaded-scripts.gif)
...
![Toggling sourcemaps off and on during a JavaScript debugging session](https://code.visualstudio.com/raw/images/1_69/js-debug-toggle-sourcemaps.gif)
...
![Displaying the toString() method output in the Variables view](https://code.visualstudio.com/raw/images/1_69/js-debug-custom-tostring.png)
...
![Step Into Targets dropdown](https://code.visualstudio.com/raw/images/1_69/js-debug-step-in-target.png)

This can be accessed via the **Debug: Step Into Target** command (`Ctrl+F11`) or by right-clicking on the line.
...
![hovering the breakpoint warning icon](https://code.visualstudio.com/raw/images/1_69/bp-hover.png)
...
![Refactor preview panel showing a refactoring that results in two changes](https://code.visualstudio.com/raw/images/1_69/refactor-preview.png)

**Refactor with Preview...** opening a pane in the workbench and opening the refactor preview editor view.

![Selecting a refactor preview that opens an editor diff view](https://code.visualstudio.com/raw/images/1_69/refactoring-editor.gif)
...
![An Emmet abbreviation being expanded in an HTML file with the inline completion setting on](https://code.visualstudio.com/raw/images/1_69/emmet-inline-html.gif)
...
![JSON notifications from the Status bar JSON language indicator](https://code.visualstudio.com/raw/images/1_69/json-notifications.png)
...
![A Quick Pick depicting two entries. The top entry is selected that has a light bulb to its left and says 'Install suggested extensions Python + Jupyter'](https://code.visualstudio.com/raw/images/1_69/jupyter-extension-install.png)
...
![Drag the + button for a multiline comment](https://code.visualstudio.com/raw/images/1_69/drag-for-comment.gif)

## Enterprise

### UpdateMode Group Policy on Windows

VS Code now has support for [Windows Registry-based Group Policy](https://docs.microsoft.com/previous-versions/windows/desktop/policy/implementing-registry-based-policy), which allows system administrators to create and deploy policies on machines they manage.
...
[https://vscode.dev/theme/github.github-vscode-theme/GitHub%20Dark%20Default](https://vscode.dev/theme/github.github-vscode-theme/GitHub Dark Default)

![Color theme tester with vscode.dev showing GitHub Theme extension GitHub Dark Default](https://code.visualstudio.com/raw/images/1_69/theme-tester-marketplace.png)
...
[https://vscode.dev/theme/vscode.theme-defaults/Default%20High%20Contrast%20Light](https://vscode.dev/theme/vscode.theme-defaults/Default High Contrast Light)
...
![The VS Code Server's help menu and a remote VS Code connection](https://code.visualstudio.com/raw/images/1_69/help-and-start.png)
...
![ESlint validating notebook cells](https://code.visualstudio.com/raw/images/1_69/eslint.png)
...
![IPyWidget support in IHaskell](https://code.visualstudio.com/raw/images/1_69/jupyter_ihaskell_widgets.gif)
...
![IPyWidget support for Chemiscope](https://code.visualstudio.com/raw/images/1_69/jupyter_chemiscope_widget.gif)

Other notable `IPyWidget` fixes include displaying complex and nested (including interactive) outputs within the [Jupyter Output widget](https://ipywidgets.readthedocs.io/en/latest/examples/Output Widget.html).
...
![Create Settings Profile](https://code.visualstudio.com/raw/images/1_69/settings-profile-create.gif)

Here shows how you can easily change from a development profile to a demo profile.

![Switching Settings Profile](https://code.visualstudio.com/raw/images/1_69/settings-profile-switch.gif)
...
![Multiple opened Profiles](https://code.visualstudio.com/raw/images/1_69/settings-profile-multiple.png)
...
![Removing Settings Profiles](https://code.visualstudio.com/raw/images/1_69/settings-profile-remove.png)
...
2. Use the latest [vscode-dts](https://www.npmjs.com/package/vscode-dts) and run `vscode-dts dev`. It will download the corresponding `d.ts` files into your workspace.
